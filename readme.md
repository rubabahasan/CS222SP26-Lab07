...
This lab is used in CS 222 at Saint Mary's College of California. Written by Dr. Sarah Roscoe and edited by Dr. Rubaba Hasan.

## Instructions

1. Clone the lab from Github. Use this link: <https://github.com/rubabahasan/CS222SP26-Lab07.git>
...
7. Ensure your project folder is named correctly, with both you and your partners' name(s). Then zip the project folder and turn it in to Canvas.
...
3. Both stacks and queues are already implemented for you in this Lab. You can find them in the packages main.queues and main.stacks. The names starting with LL has a linked list implementation while the versions with AL uses an array implementation using ArrayLists. Use any of the Stack or Queue classes that you think you might need. The implemented stacks/queues have additional methods like isEmpty().
